...
("Name", "Slug", "ShortDesc", "Description", "Category", "Brand", "Image", "Price", "Stock") 
VALUES
...
('Azithromycin 500mg', 'azithromycin-500mg', 'Kháng sinh thế hệ mới', 'Thuốc kháng sinh nhóm macrolide, hiệu quả cao với nhiều chủng vi khuẩn. Điều trị viêm phế quản, nhiễm khuẩn tai.', 'thuoc', 'Domesco', 'azithromycin.jpg', 45000, 80),
...
('Diclofenac 50mg', 'diclofenac-50mg', 'Chống viêm, giảm đau', 'Thuốc chống viêm không steroid Diclofenac, giảm đau cấp và mãn tính, hạ sốt.', 'thuoc', 'Novartis', 'diclofenac.jpg', 22000, 150),
...
('Naproxen 500mg', 'naproxen-500mg', 'Giảm đau lâu dài', 'Naproxen 500mg, thuốc chống viêm NSAID, giảm đau kéo dài, hạ sốt. An toàn với dạ dày.', 'thuoc', 'Roche', 'naproxen.jpg', 26000, 130),
('Doxycycline 100mg', 'doxycycline-100mg', 'Kháng sinh phổ rộng', 'Thuốc kháng sinh Doxycycline, điều trị nhiễm khuẩn, mụn trứng cá, bệnh Lyme.', 'thuoc', 'Farma', 'doxycycline.jpg', 32000, 110),
...
('Metronidazole 250mg', 'metronidazole-250mg', 'Kháng sinh đặc biệt', 'Metronidazole 250mg, điều trị nhiễm khuẩn do amoeba, trichomonas, Giardia.', 'thuoc', 'Biofarma', 'metronidazole.jpg', 20000, 200),
('Vitamin D3 1000IU', 'vitamin-d3-1000iu', 'Mạnh xương, miễn dịch', 'Vitamin D3 1000 đơn vị quốc tế, hỗ trợ hấp thu canxi, giúp xương chắc khỏe, tăng miễn dịch.', 'vitamin', 'Nutricost', 'vitamin-d3.jpg', 52000, 180),
...
('Omega 3 Fish Oil', 'omega-3-fish-oil', 'Bảo vệ tim mạch', 'Dầu cá Omega 3 giúp bảo vệ tim mạch, giảm cholesterol, tốt cho não bộ.', 'vitamin', 'Kirkland', 'omega3.jpg', 48000, 140),
('Collagen Type I + II', 'collagen-type-1-2', 'Làm đẹp da, khớp', 'Collagen thủy phân, giúp da săn chắc, khớp linh hoạt, tóc và móng khỏe.', 'vitamin', 'EFAVIT', 'collagen.jpg', 62000, 100),
('Viên Multivitamin hằng ngày', 'multivitamin-daily', 'Bổ sung vitamin tổng hợp', 'Viên nén tổng hợp 13 vitamin và khoáng chất, bổ sung năng lượng hằng ngày.', 'vitamin', 'Centrum', 'multivitamin.jpg', 72000, 160),
...
('Sữa rửa mặt Cleanser', 'sua-rua-mat-cleanser', 'Sạch sâu, mịn da', 'Sữa rửa mặt dịu nhẹ, loại bỏ bụi bẩn, trang điểm, dưỡng ẩm da mặt.', 'cham-soc', 'Cetaphil', 'cleanser.jpg', 45000, 200),
('Kem chống nắng SPF 50', 'kem-chong-nang-spf50', 'Bảo vệ 8 tiếng', 'Kem chống nắng SPF 50+ PA+++, bảo vệ da khỏi tia UV, không nhờn, dễ rửa trôi.', 'cham-soc', 'Sunplay', 'sunscreen.jpg', 55000, 180),
('Mặt nạ chăm sóc da', 'face-mask-care', 'Dưỡng ẩm sâu', 'Mặt nạ giấy chứa serum dưỡng chất, cấp ẩm, sáng da, dùng 2-3 lần/tuần.', 'cham-soc', 'Nature Republic', 'face-mask.jpg', 38000, 300),
('Kem đánh răng Fluoride', 'kem-danh-rang-fluoride', 'Bảo vệ men răng', 'Kem đánh răng chứa Fluoride, ngăn ngừa sâu răng, làm sáng men răng.', 'cham-soc', 'Colgate', 'toothpaste.jpg', 25000, 400),
('Dầu gội xả 2 trong 1', 'shampoo-2-in-1', 'Mượt và bóng tóc', 'Dầu gội xả 2 trong 1, giàu vitamin E, nuôi dưỡng tóc mềm mượt, chống gàu.', 'cham-soc', 'Pantene', 'shampoo.jpg', 36000, 280),
('Nước súc miệng kháng khuẩn', 'mouthwash-antiseptic', 'Diệt khuẩn, thơm miệng', 'Nước súc miệng sát trùng, giảm viêm lợi, hôi miệng, thơm tho suốt ngày.', 'cham-soc', 'Listerine', 'mouthwash.jpg', 68000, 200),
('Máy xông hơi Nebulizer', 'may-xong-hoi-nebulizer', 'Chữa hen, ho', 'Máy xông hơi tạo hạt mịn, hiệu quả điều trị hen suyễn, ho mãn tính. Dễ sử dụng.', 'thiet-bi', 'Medel', 'nebulizer.jpg', 380000, 30),
...
('Máy đo đường huyết', 'glucose-meter', 'Đo đường huyết nhanh', 'Máy đo đường huyết chính xác cao, kết quả trong 5 giây, kèm 10 que test.', 'thiet-bi', 'Accu-Chek', 'glucose-meter.jpg', 250000, 50),
('Máy đo huyết áp điện tử', 'bp-monitor-digital', 'Đo huyết áp di động', 'Máy đo huyết áp cánh tay nhỏ gọn, pin lâu 60 giờ, màn hình LED rõ ràng.', 'thiet-bi', 'SENCOR', 'bp-monitor.jpg', 320000, 40),
('Nhiệt kế hồng ngoại', 'thermometer-infrared', 'Đo nhiệt độ không tiếp xúc', 'Nhiệt kế hồng ngoại đo nhanh 1 giây, không cần tiếp xúc, màn hình LED.', 'thiet-bi', 'Beurer', 'thermometer.jpg', 180000, 60);
